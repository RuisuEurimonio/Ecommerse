...
const OurService : React.FC<OurServiceProps> = () => {
    return (
        <div className="custom_content">
            <h2 className="custom_title"> Por qué comprar con nosotros. </h2>
            ...
            ">
                <li className="flex flex-col flex-1 items-center p-3 border-2 w-full rounded-lg border-black-mafer/20 max-w-52 min-w-40  h-[19rem]"> 
                    <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                        lg:h-16 lg:w-16
                    ">
                        <span className="icon icon-ranking text-xl
                            lg:text-2xl
                            2xl:text-3xl
                        "/>
                    </div>
                ...
                <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                    lg:h-16 lg:w-16
                ">
                    <span className="icon icon-arrow-rotate text-2xl
                        lg:text-2xl
                        2xl:text-3xl
                    "/>    
                </div>
                ...
                <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                    lg:h-16 lg:w-16
                ">
                    <span className="icon icon-global text-2xl
                        lg:text-2xl
                        2xl:text-3xl
                    "/>    
                </div>
