...
const OurService : React.FC<OurServiceProps> = () => {
    return (
        <div className="custom_content">
            <h2 className="custom_title text-secondary-color"> Por qué comprar con nosotros. </h2>
            ...
            ">
                <li className="flex flex-col flex-1 items-center p-3 border-2 w-full rounded-lg border-fourth-color/20 max-w-52 min-w-40  h-[19rem]"> 
                    <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                        lg:h-16 lg:w-16
                    ">
                        <span className="icon icon-ranking text-xl text-secondary-color
                            lg:text-2xl
                            2xl:text-3xl
                        "/>
                    </div>
                    <h3 className="text-base text-center font-bold text-secondary-color
                        lg:text-lg
                    "> Mejor servicio. </h3>
                ...
                <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                    lg:h-16 lg:w-16
                ">
                    <span className="icon icon-arrow-rotate text-2xl text-secondary-color
                        lg:text-2xl
                        2xl:text-3xl
                    "/>    
                </div>
                ...
                <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                    lg:h-16 lg:w-16
                ">
                    <span className="icon icon-truck text-2xl text-secondary-color
                        lg:text-2xl
                        2xl:text-3xl
                    "/>    
                </div>
                ...
                <div className="flex justify-center items-center h-14 w-14 border-2 rounded-full my-4
                    lg:h-16 lg:w-16
                ">
                    <span className="icon icon-global text-2xl text-secondary-color
                        lg:text-2xl
                        2xl:text-3xl
                    "/>    
                </div>
