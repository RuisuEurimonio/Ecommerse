        ...
        <ul>
            <li>
                ...
                <ul className="list-disc">
                    <li className="ml-5 my-2" style={{textDecoration: (pathName === undefined) ? "underline" : "none"}}>
                        {" "}
            ...
            <li>
                ...
                <ul className="list-disc">
                    <li className="ml-5 my-2" style={{textDecoration: (pathName === "configuration-users") ? "underline" : "none"}}>
                        {" "}
