    ...
    return(
        <>
            ...
            <div className="w-11/12 mx-auto  my-2
                md:w-4/5">
                <h2 className="text-center text-fourth-color font-bold text-2xl"> Ruisu&aposs Software. </h2>
                <p className="text-justify"> Fundada en 2024, nació con la visión de revolucionar el mercado tecnológico. En sus inicios, la compañía se centró en proporcionar soluciones innovadoras y accesibles para empresas y usuarios individuales, combinando tecnología avanzada con un servicio al cliente excepcional. Desde su creación, Ruisu&aposs Software ha trabajado incansablemente para establecerse como líder en la industria. </p>
